...
<section class="nosso-processo">
    <div class="container">
        <div class="flex gap-10 items-end nosso-processo__header">
            ...
            <div class="w-auto">
                <div class="nosso-processo__carousel-nav">
                    <button class="nosso-processo__carousel-nav-button nosso-processo__carousel-nav-button--prev">
                        <?php echo icon('arrow-left'); ?>
                    </button>
                    <button class="nosso-processo__carousel-nav-button nosso-processo__carousel-nav-button--next">
